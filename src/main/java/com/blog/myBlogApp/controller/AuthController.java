...
@Api(value = "Auth Controller for Sign in and Register REST APIs")
@RestController
...
public class AuthController {
    ...
    @ApiOperation(value = "REST API for sign in operation")
    @PostMapping("/login")
    ...
    @ApiOperation(value = "REST API for sign up operation")
    @PostMapping("/signup")
